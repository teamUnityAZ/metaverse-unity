...
{
    [CustomEditor(typeof(ScrollRectFaster), true)]
    [CanEditMultipleObjects]
    public class ScrollRectFasterEditor : Editor
    {
        ...
        {
            SetAnimBool(m_ShowElasticity, !m_MovementType.hasMultipleDifferentValues && m_MovementType.enumValueIndex == (int)ScrollRectFaster.MovementType.Elastic, instant);
        ...
        void CalculateCachedValues()
        {
            ...
            if (targets.Length == 1)
            {
                Transform transform = ((ScrollRectFaster)target).transform;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (m_HorizontalScrollbar.objectReferenceValue && !m_HorizontalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((ScrollRectFaster.ScrollbarVisibility)m_HorizontalScrollbarVisibility.enumValueIndex == ScrollRectFaster.ScrollbarVisibility.AutoHideAndExpandViewport
            ...
            if (m_VerticalScrollbar.objectReferenceValue && !m_VerticalScrollbar.hasMultipleDifferentValues)
            {
                ...
                if ((ScrollRectFaster.ScrollbarVisibility)m_VerticalScrollbarVisibility.enumValueIndex == ScrollRectFaster.ScrollbarVisibility.AutoHideAndExpandViewport
