...
{
    [AddComponentMenu("UI/Extensions/ScrollRectFasterEx")]
    public class ScrollRectFasterEx : ScrollRectFaster
    {
        ...
        public bool isClaimedDragging;

        public float m_InitialPosition;

        public float currentDragPos;
        ...
        public override void OnDrag(UnityEngine.EventSystems.PointerEventData eventData)
        {
            ...
            else
            {
                ...
                //Debug.LogError("ondrag1:" + eventData.position);
                //isClaimedDragging = true;
        ...
        public override void OnBeginDrag(UnityEngine.EventSystems.PointerEventData eventData)
        {
            ...
            else
            {
                ...
                isClaimedDragging = true;
                m_InitialPosition = eventData.position.y;
                //Debug.LogError("ondrag0:" + eventData.position);
            }
