...
namespace UnityEngine.XR.ARFoundation.Samples
{
    ...
    public class ARKitBlendShapeVisualizer2 : MonoBehaviour
    {
        [SerializeField]
        ...
        void Awake()
        {
            ...
            skinnedMeshRenderer = ARFacePoseTrackingManager.Instance.m_SkinnedMeshRenderer;
        ...
        {
            //Debug.LogError("CreateFeatureBlendMapping0000.......");
...
#if UNITY_IOS && !UNITY_EDITOR
            string strPrefix = "Blandshapes_Face.";
